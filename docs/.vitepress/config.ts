...
/**
 * The documentation site for `@vit-foundation/chart`.
 *
...
export default defineConfig({
	title: '@vit-foundation/chart',
	description:
		'Colour scales and the legends that describe them: class bands, ramp legends, and the arithmetic both a renderer and a legend must agree on.',
	cleanUrls: true,
	lastUpdated: true,
	themeConfig: {
		nav: [
		...
		sidebar: [
			{
				...
				items: [
					...
					{ text: 'The scale', link: '/scale' },
					{ text: 'The legend', link: '/legend' }
				]
			},
		...
		socialLinks: [{ icon: 'github', link: 'https://github.com/fndvit/VizVit-Chart' }],
		search: { provider: 'local' },
		editLink: {
			pattern: 'https://github.com/fndvit/VizVit-Chart/edit/main/docs/:path',
